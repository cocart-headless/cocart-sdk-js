...
describe('Timezone Utilities', () => {
  ...
  describe('convertDateTimezone', () => {
    it('should convert between timezones', () => {
      ...
      const londonDate = convertDateTimezone(nyDate, 'America/New_York', 'Europe/London');
      ...
      const backToNY = convertDateTimezone(londonDate, 'Europe/London', 'America/New_York');
